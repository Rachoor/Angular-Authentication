...
export class ProductsComponent implements OnInit {
  ...
  remove(id) {
    this.backend.removeProduct(id).subscribe(response => {
  ...
  updateProduct(id, name, price, category) {
    ...
    this.backend.updateProduct(id, product).subscribe(response => {
      console.log(response);
      this.refreshNow();
    });
  }
